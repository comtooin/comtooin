...
5. 구분선 활용: 섹션 사이에는 '---' 또는 '━'를 사용하여 명확히 구분한다.
6. 요약 박스: 리포트 최상단에 '금월 핵심 요약(Key Summary)'을 3줄 이내의 박스 형태로 작성하여 바쁜 담당자가 빠르게 파악하게 한다.
7. 강조 기법: 중요한 수치나 긴급한 교체 제언은 **[강조]** 또는 **굵게** 표시하여 시각적 우선순위를 부여한다.
