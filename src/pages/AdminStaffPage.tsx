    ...
    <Container maxWidth="lg">
      ...
      <Box sx={{ mb: { xs: 1.5, sm: 2, md: 2.5 } }}>
        <Stack direction="row" alignItems="center" spacing={{ xs: 1, sm: 1.25, md: 1.5 }} mb={{ xs: 0.25, sm: 0.5, md: 1 }}>
          <PeopleIcon sx={{ fontSize: { xs: '1.6rem', sm: '1.9rem', md: '2.2rem' }, color: 'primary.main' }} />
      ...
      <Grid container spacing={{ xs: 1, sm: 1.5 }} sx={{ mb: 2.5 }}>
        {[
          { 
            label: '총 멤버', 
            count: stats.total, 
            icon: <PeopleIcon sx={{ fontSize: { xs: 13, sm: 20 }, color: '#3b82f6' }} />, 
            bgColor: 'rgba(59, 130, 246, 0.08)' 
          },
          { 
            label: '신규 멤버', 
            count: stats.recent, 
            icon: <PersonAddIcon sx={{ fontSize: { xs: 13, sm: 20 }, color: '#10b981' }} />, 
            bgColor: 'rgba(16, 185, 129, 0.08)' 
          },
          { 
            label: '관리자', 
            count: stats.admin, 
            icon: <AssignmentIndIcon sx={{ fontSize: { xs: 13, sm: 20 }, color: '#f59e0b' }} />, 
